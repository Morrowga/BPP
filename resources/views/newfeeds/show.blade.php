        ...
        <div class="col-md-4">
            <div class="card" style="text-align:center; padding-top: 20px;">
                <dl class="dl-horizontal">
                    <dt><h5 style="font-weight:bold; font-family: 'Noto Serif', serif;">URL:</h5></dt>
                    <dd> <a href="{{ route('feeds.single', $feed->slug) }}">{{ url($feed->slug) }} </a></dd>
                </dl>
                <dl class="dl-horizontal">
                ...
                <div class="row" style="padding-right: 5px;">
                    <div class="col-sm-6">
                        {{ Html::linkRoute('newfeeds.edit', 'Edit', array($feed->id), array('class' => 'btn btn-light btn-block', 'style'=> 'font-family: Noto Serif, serif; margin-bottom: 10px; margin-left: 8px;')) }}
                    </div>
                    <div class="col-sm-6">
                        {{ Form::open(['route' => ['newfeeds.destroy', $feed->id], 'method' => 'DELETE']) }}
                        {{ Form::submit('Delete', ['class' => 'btn btn-danger btn-block', 'style'=> 'font-family: Noto Serif, serif;']) }}
                        {{ Form::close() }}
                    </div>
                </div>
                 <div class="row">
                    <div class="col-md-12">
                        {{ Html::linkRoute('newfeeds.newfeedhist', '<< See All Posts', array(), ['class' => 'btn btn-success btn-h1-spacing', 'style' => 'margin-top: 5px; margin-bottom: 10px; font-family: Noto Serif, serif;']) }}
                    </div>
                 </div>
            </div>
        </div><!--col-md-4-->
