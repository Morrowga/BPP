...
<div class="row justify-content-between display-row-table">
  ...
  <div class="col-sm-10 w-100">
        ...
        <div class="card-header" style="text-align: left; font-family: 'Noto Serif', serif;">
            <h1 style="margin-left: 5px;">Settings</h1>
            <div class="row">
            <a href="{{ route('tasks.create') }}" class="btn btn-outline-secondary" style="margin-left: 85%; padding-top:">New Customize</a>

            </div>                
            </div>
            <div class="card-body">
            <div class="row mt-2">
                <label class="site font-weight-bold pl-3 pt-2" style="font-family: 'Noto Serif', serif;" for="exampleInputEmail">Site Email Address </label>
                <input type="email" style="margin-left: 55px; "class="form-control email w-50" 
                id="exampleInputEmail" aria-describedby="EmailHelp" placeholder="">
            </div>
            <div class="row mt-2">
                <label class="site font-weight-bold pl-3 pt-2" style="font-family: 'Noto Serif', serif;" for="exampleInputEmail">Site Description </label>
                <input type="" style="margin-left: 75px; "class="form-control email w-50" 
                id="exampleInputEmail" aria-describedby="EmailHelp" placeholder="">
            </div>
            <div class="row mt-2">
                <label class="site font-weight-bold pl-3 pt-2" style="font-family: 'Noto Serif', serif;" for="exampleInputEmail">Contact Number</label>
                <input type="email" style="margin-left: 70px; "class="form-control email w-50" 
                id="exampleInputEmail" aria-describedby="EmailHelp" placeholder="">
            </div>
