...
<div class="row justify-content-between display-row-table">
  ...
  <div class="col-sm-10 w-100">
        ...
        <div class="card-header" style="text-align: left; font-family: 'Noto Serif', serif;">
            ...
            <div class="card-body">
            {{ Form::open(array('route' => 'tasks.store', 'data-parsley-validate' => '')) }}
            <div class="row mt-2">
            {{ Form::label('email', 'Site Email Address', array('style'=> 'font-family: Noto Serif, serif; margin-left: 20px; margin-top: 5px; font-weight: bold;')) }}
            {{ Form::text('email', null, array('class' => 'form-control', 'placeholder' => '', 'style' => 'margin-left: 55px; width: 50%;')) }}
            </div>
            <div class="row mt-2">
            {{ Form::label('description', 'Site Description', array('style'=> 'font-family: Noto Serif, serif; margin-left: 20px; margin-top: 10px; font-weight: bold;')) }}
            {{ Form::text('decription', null, array('class' => 'form-control', 'style' => 'margin-left: 75px; width: 50%;')) }}
            </div>
            <div class="row mt-2">
            {{ Form::label('number', 'Contact Number', array('style'=> 'font-family: Noto Serif, serif; margin-left: 20px; margin-top: 5px; font-weight:bold;')) }}
            {{ Form::text('number', null, array('class' => 'form-control', 'style' => 'margin-left: 71px; width: 50%;')) }}
            </div>
            {{ Form::submit('Save', array('class' => 'btn btn-outline-secondary', 'style' => 'margin-right:10px; margin-top: 20px; font-weight: bold; font-family: Noto Serif, serif; float:right; width: 10%;')) }}
            {{ Form::close() }}
            </div><!--card-body-->
        </div><!--card-->
  </div><!--col-sm-10-->
