...
<div class="row justify-content-between display-row-table">
  ...
  <div class="col-sm-10 w-100">
        ...
        <div class="card-header" style="text-align: left; font-family: 'Noto Serif', serif;">
            ...
            <div class="card-body">
            <div class="row mt-2">
                <label class="site font-weight-bold pl-3 pt-2" style="font-family: 'Noto Serif', serif;" for="exampleInputEmail">Email </label>
                <input type="email" style="margin-left: 95px; "class="form-control email w-50" id="exampleInputEmail" aria-describedby="EmailHelp" placeholder="mr.alvin199818@gmail.com">
                <div class="btn btn-outline-secondary editBtn ml-3">
                Edit
            </div>
            </div><!--row-->
            </div><!--card-body-->
