        ...
        <div class="col-md-4">
            <div class="card" style="text-align:center; padding-top: 20px;">
                ...
                <div class="row" style="padding-right: 5px;">
                    <div class="col-sm-6">
                        {{ Html::linkRoute('posts.show', 'Cancel', array($post->id), array('class' => 'btn btn-light btn-block', 'style'=> 'font-family: Noto Serif, serif; margin-bottom: 10px; margin-left: 8px;')) }}
                    </div>
                    <div class="col-sm-6">
