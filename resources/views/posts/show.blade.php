        ...
        <div class="col-md-4">
            <div class="card" style="text-align:center; padding-top: 20px;">
                <dl class="dl-horizontal">
                    ...
                    <dd> <a href="{{ route('blogg.single', $post->slug) }}">{{ url($post->slug) }} </a></dd>
                </dl>
                <dl class="dl-horizontal">
                ...
                <div class="row" style="padding-right: 5px;">
                    <div class="col-sm-6">
                        {{ Html::linkRoute('posts.edit', 'Edit', array($post->id), array('class' => 'btn btn-light btn-block', 'style'=> 'font-family: Noto Serif, serif; margin-bottom: 10px; margin-left: 8px;')) }}
                    </div>
                    <div class="col-sm-6">
                 ...
                 <div class="row">
                    <div class="col-md-12">
                        {{ Html::linkRoute('posts.bloghist', '<< See All Posts', array(), ['class' => 'btn btn-success btn-h1-spacing', 'style' => 'margin-top: 5px; margin-bottom: 10px; font-family: Noto Serif, serif;']) }}
                    </div>
                 </div>
            </div>
        </div><!--col-md-4-->
